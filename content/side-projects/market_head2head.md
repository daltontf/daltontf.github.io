...
I had become familiar with the ESPN API when writing what was originally my "roScore" Roku App" <https://github.com/daltontf/roScore> and developed scripts to store such data in MySQL database. Over time I had to find other sources of older and more obscure results like <https://retrosheet.org/>, <https://www.hockeydb.com> and sometimes just copying out of Wikipedia into a spreadsheet and generating SQL from it.
